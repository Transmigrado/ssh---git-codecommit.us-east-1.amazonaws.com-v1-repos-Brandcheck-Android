package io.ebinar.infolder.font;
...
/**
 * Created by jorgeacostaalvarado on 25-06-15.
 */
public class RobotoFontelloButton extends Button {

    private static Typeface sFontello;
    private static Typeface sRoboto;

    public RobotoFontelloButton(Context context) {
        super(context);
    ...
    public RobotoFontelloButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public RobotoFontelloButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setTypeface() {
        ...
        spannableString.setSpan(new CustomTypefaceSpan("sans-serif",sFontello),0,1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableString.setSpan(new CustomTypefaceSpan("sans-serif",sRoboto),1,getText().length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
